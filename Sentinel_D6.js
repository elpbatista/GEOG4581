/*
===============================================================================
 GEOG 4/581 Final Project - Sentinel Analysis Script (Deliverable #6)
 ...
 Script Purpose:
   - Generate results for Deliverable #6, following the project plan and analysis steps.
...
var colorBrewer = ['#e41a1c', '#377eb8', '#4daf4a', '#984ea3', '#ff7f00', '#ffff33', '#a65628', '#f781bf'];
...
// Add a layer for each feature in the FeatureCollection with a unique color
allFeatures.evaluate(function (result){
  result.features.forEach(function (feature, idx) {
    print("Location: " + feature.properties.name);
    print("Area: " + feature.properties.gis_area);
    do_something_else();
    print("----------------------");
    ...
    Map.addLayer(study_area, { color: color }, label + " Study Area");
